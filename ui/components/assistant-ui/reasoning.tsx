...
function ReasoningText({ className, ...props }: React.ComponentProps<'div'>) {
	return (
		<div
			...
			className={cn(
				'aui-reasoning-text relative z-0 max-h-64 overflow-y-auto pt-4 pb-2 pl-2 pr-6 leading-relaxed',
...
const ReasoningGroupImpl: ReasoningGroupComponent = ({ children, startIndex, endIndex, variant }: any) => {
	...
	return (
		<ReasoningRoot defaultOpen={false} variant={variant}>
